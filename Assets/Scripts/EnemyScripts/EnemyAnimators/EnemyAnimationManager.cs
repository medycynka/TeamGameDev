        ...
        private void Awake()
        {
            ...
            if (StaticAnimatorIds.enemyAnimationIds == null)
            {
                StaticAnimatorIds.enemyAnimationIds = new Dictionary<string, int>
                {
                    ...
                    {StaticAnimatorIds.BossAttack01, Animator.StringToHash(StaticAnimatorIds.BossAttack01)},
                    {StaticAnimatorIds.BossAttack02, Animator.StringToHash(StaticAnimatorIds.BossAttack02)},
                    {StaticAnimatorIds.BossAttack03, Animator.StringToHash(StaticAnimatorIds.BossAttack03)},
                    {StaticAnimatorIds.BossAttack04, Animator.StringToHash(StaticAnimatorIds.BossAttack04)},
                    {StaticAnimatorIds.BossCombo01, Animator.StringToHash(StaticAnimatorIds.BossCombo01)},
                    {StaticAnimatorIds.BossCombo02, Animator.StringToHash(StaticAnimatorIds.BossCombo02)},
